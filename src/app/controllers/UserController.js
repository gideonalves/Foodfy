...
module.exports = {
  async list(req, res) {
    ...
    if (success) {
      res.render('admin/users/list', { users, success, pagination });
      req.session.success = '';
      return
    }

    return res.render('admin/users/list', { users, pagination });
  },
  ...
  async post(req, res) {
    ...
    const welcomeEmail = `
        ...
        <p style="text-align: center;">
                <a
                    ...
                    href="http://localhost:3000/admin/login" target="_blank"
                >Acessar</a> 
        </p>
    ...
    let userId = await User.create(data)
